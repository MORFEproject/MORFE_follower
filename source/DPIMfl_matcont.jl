...
function matcont(nodes::Vector{Snode},M::SparseMatrixCSC{Float64},V::Matrix{ComplexF64},P::Vector{Parametrisation},folder::String)
...
file = matopen("./" * folder * "/param.mat","w")
